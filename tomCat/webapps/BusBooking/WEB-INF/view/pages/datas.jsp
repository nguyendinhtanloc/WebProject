                ...
                <tbody>
                    <c:forEach var="log" items="${logList}">
                        <tr>
                            ...
                            <td>
                                <c:out value="${log.oldContent != null ? log.oldContent : '-'}" />
                            </td>
                            <td>
                                <c:out value="${log.newContent != null ? log.newContent : '-'}" />
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <c:if test="${totalPages > 1}">
                <div class="pagination-container">
                    ...
                    <a href="?page=${currentPage - 1}"
                        class="pagination-btn ${currentPage == 1 ? 'disabled' : ''}">&lsaquo;</a>
                    ...
                    <a href="?page=${currentPage + 1}"
                        class="pagination-btn ${currentPage == totalPages ? 'disabled' : ''}">&rsaquo;</a>
                    <a href="?page=${totalPages}"
                        class="pagination-btn ${currentPage == totalPages ? 'disabled' : ''}">&raquo;</a>
                </div>
            </c:if>
        </div>